 ...
 * <p>
 * This is the class containing the logic for question 1
 * of the assignment. The purpose of this class is to multiply
 * two given matrices by a sequential method, then compare the
 * time taken for the said operation to that of a parallel
